...
class _RentalItemsPageState extends State<RentalItemsPage> {
  ...
  Widget _buildAddRentalForm([StateSetter? dialogSetState, BuildContext? dialogContext]) {
    ...
    final propertyTypeCtl = TextEditingController(text: existing?['name']?.toString() ?? '');
                              ...
                              try {
                                ...
                                await widget.db.into(widget.db.rentalItems).insertOnConflictUpdate(
                                  RentalItemsCompanion(
                                    ...
                                    name: propertyTypeCtl.text.trim().isEmpty 
                                        ? const d.Value('')
                                        : d.Value(propertyTypeCtl.text.trim()),
                                ...
                                _syncToFirestore(
                                  ...
                                  data: {
                                    ...
                                    'name': propertyTypeCtl.text.trim(),
  ...
  Future<void> _showDetailedData(String title, String filterType, String? status) async {
    ...
    switch (filterType) {
      case 'files':
        ...
        data = result.map((r) => r.data).toList();
        break;
      case 'properties':
        if (status == 'total') {
    ...
    switch (_navIndex) {
      case 1:
        if (!_canAccessNavIndex(1)) {
          ...
          content = _db == null ? const SizedBox.shrink() : FilesPage(db: _db!);
        }
        break;
      case 2:
      ...
      case 4:
        ...
        break;
      case 5:
        content = _db == null ? const SizedBox.shrink() : SettingsPage(db: _db!);
        break;
      case 6:
