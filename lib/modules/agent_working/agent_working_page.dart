...
import '../../presentation/view_models/agent_view_model.dart';
...
class _AgentWorkingPageState extends State<AgentWorkingPage> {
        ...
        return Focus(
          ...
          child: Scaffold(
              ...
              title: Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.work, color: Colors.purple.shade600, size: 20),
                  ),
            ...
            body: Container(
              ...
              child: Column(
                children: [
                  // Tab bar for Transfer/Client Requirements
                  Container(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: _viewModel.selectedType == 'Transfer' 
                              ...
                              child: Text(
                                ...
                                style: AppFonts.poppins(
                                  ...
                                  fontWeight: _viewModel.selectedType == 'Transfer' 
                                      ? FontWeight.w600 
                                      : FontWeight.w500,
                                ),
                              ),
                        ...
                        Expanded(
                          child: GestureDetector(
                            onTap: () => _onTypeChanged('Client Requirements'),
                            child: Container(
                              padding: const EdgeInsets.symmetric(vertical: 12),
                              decoration: BoxDecoration(
                                color: _viewModel.selectedType == 'Client Requirements' 
                                    ? const Color(0xFFFF6B35) 
                                    : Colors.transparent,
                                borderRadius: BorderRadius.circular(8),
                              ),
                              child: Text(
                                ...
                                style: AppFonts.poppins(
                                  color: _viewModel.selectedType == 'Client Requirements' 
                                      ? Colors.white 
                                      : Colors.grey.shade700,
                                  fontWeight: _viewModel.selectedType == 'Client Requirements' 
                                      ? FontWeight.w600 
                                      : FontWeight.w500,
                                ),
                              ),
  ...
  Widget _buildMainContent() {
    if (_viewModel.selectedType == 'Transfer') {
      ...
      return _buildClientRequirementContent();
    }
  }
  ...
  Widget _buildTransferContent() {
    return Column(
      children: [
        ...
        // Transfers List
        Expanded(
          child: _viewModel.transfers.isEmpty
  ...
  Widget _buildClientRequirementContent() {
    return Column(
      children: [
        // Add Client Requirement Button
        Container(
          margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
          child: PrimaryGradientButton(
            text: 'Add Client Requirement',
        ...
        Expanded(
          child: _viewModel.clientRequirements.isEmpty
                ...
                child: SingleChildScrollView(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        // Date picker
                        _buildDateField('Date', _viewModel.dateCtl, _pickDate),
                        const SizedBox(height: 16),
                        
                        // Client name
                        _buildTextField('Client Name', _viewModel.clientNameCtl),
                        const SizedBox(height: 16),
                        ...
                        // Comments
                        _buildTextField('Comments', _viewModel.commentsCtl, maxLines: 3),
                        const SizedBox(height: 16),
                        
                        // Next working date
                        _buildDateField('Next Working Date', _viewModel.nextWorkingDateCtl, _pickNextWorkingDate),
                ...
                child: SingleChildScrollView(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        // Date picker
                        _buildDateField('Date', _viewModel.reqDateCtl, _pickRequirementDate),
                        const SizedBox(height: 16),
                        
                        // Client name
                        _buildTextField('Client Name', _viewModel.reqClientNameCtl),
                        const SizedBox(height: 16),
                        ...
                        // Comments
                        _buildTextField('Comments', _viewModel.reqCommentsCtl, maxLines: 3),
                        const SizedBox(height: 16),
                        
                        // Next working date
                        _buildDateField('Next Working Date', _viewModel.reqNextWorkingDateCtl, _pickReqNextWorkingDate),
                        const SizedBox(height: 24),
